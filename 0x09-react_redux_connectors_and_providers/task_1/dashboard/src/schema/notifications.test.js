...
describe("Test for notifications.js", () => {
    it("verifies that notifications returns correct data", () => {
        const result = [
            {
    ...
    it("should have a correct messages entity", () => {
      ...
      expect(
        normalized.entities.message["efb6c485-00f7-4fdf-97cc-5e12d14d6c41"]
      ).toEqual(message);
    });
    ...
    it("should have correct notifications entity", () => {
      ...
      expect(normalized.entities.notifications["5debd7642e815cd350407777"]).toEqual(notifier);
    });
  });