...
describe("Course List Row component test", () => {
    ...
    it("should render one cell with colspan = 2 when textFirstCell null", () => {
        const wrapper = shallow(<CourseListRow isHeader={true} textFirstCell="text" textSecondCell={null}/>);
