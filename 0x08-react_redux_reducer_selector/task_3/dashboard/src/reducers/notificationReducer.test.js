...
describe("tests for notification reducer", () => {
    ...
    it("should mark the correct notification as read", () => {
        ...
        expect(notificationReducer(data, markAsAread(2))).toEqual(output)
    })
    ...
    it("should change filter", () => {
        ...
        expect(notificationReducer(data, setNotificationFilter("URGENT"))).toEqual(output);
    })
    ...
    it ("should return correct state on successful fetch", () => {
        ...
        expect(notificationReducer(defaultState, fetchNotificationSucess())).toEqual(data);
    })
})